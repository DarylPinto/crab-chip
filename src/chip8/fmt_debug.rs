...
impl std::fmt::Debug for Chip8 {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        // writeln!(f, "\tNext 10 bytes of memory at PC: {:#04x?}", &self.memory[self.program_counter as usize..(self.program_counter + 10) as usize]);
        ...
        writeln!(f, "\tV Keypad: {:02x?}", self.keypad);
